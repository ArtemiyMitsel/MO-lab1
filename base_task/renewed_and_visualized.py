...
final_point_nm, trajectory_quadratic_nm = nelder_mead_with_trajectory(quadratic, start_point_quadratic)
final_point_nm, len(trajectory_quadratic_nm)
...
for i in range(1, 5):
    ...
    final_point_ext_gd, trajectory_ext_gd = gradient_descent_with_trajectory(extended_rosenbrock_grad, start_point_extended)
...
final_point_gp_dich, trajectory_gp_dich = gradient_descent_dichotomy_with_trajectory(goldstein_price, goldstein_price_grad, start_point_bad)
...
final_point_r_dich, trajectory_r_dich = gradient_descent_dichotomy_with_trajectory(rastrigin, rastrigin_grad, start_point_bad)
